...
public class UserMapperTest {
    ...
    public void insert() throws Exception {
        UserModel userModel1 = UserModel.builder().name("peigen").build();
    ...
    public void insertBatch() throws Exception {
        ...
        for (int i = 1; i <= 5; i++) {
            userModelList.add(UserModel.builder().name("peigen-" + i).age(30 + i).salary(10000.00 * i).build());
            userModelList.add(UserModel.builder().name("javacode2020-" + i).age(30 + i).salary(10000.00 * i).build());
        }
        UserUtil.callMapper(UserMapper.class, mapper -> {
    ...
    public void update() throws Exception {
        ...
        log.info("---------------------");
        //将userId=3的name修改为：根,薪水为：1000.88
        Long userId2 = 3L;
    ...
    public void getModelList2() throws Exception {
        //查询姓名中包含peigen以及薪资大于3万的用户id、姓名
        Map<String, Object> map = new HashMap<>();
        map.put("nameLike", "peigen");
    ...
    public void getPage() throws Exception {
        //查询姓名中包含peigen以及薪资大于3万的用户id，按照薪资倒叙，每页5条取第1页
        Map<String, Object> map = new HashMap<>();
        map.put("nameLike", "peigen");
        map.put("salaryGte", 30000.00D);
